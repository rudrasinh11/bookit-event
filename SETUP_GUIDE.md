...
3. **Set Up Database Access (Credentials)**:
   ...
   - Set a Username (e.g., `BookITdmin`) and a Password (e.g., `BookITpassword`). **Remember these.**
   - Click **Add User**.
...
5. **Get Your Connection String**:
   ...
   - Copy the connection string provided. It will look something like this:
     `mongodb+srv://BookITdmin:<password>@cluster0.xxxxx.mongodb.net/?retryWrites=true&w=majority`
...
5. Generate a new App Password (select "Other" and name it "BookIT").
...
MONGO_URI=mongodb+srv://BookITdmin:your_actual_password@cluster0.xxxxx.mongodb.net/BookIT?retryWrites=true&w=majority

# This can be any random string, but keep it secure.
JWT_SECRET=supersecretjwtkey_BookIT
...
I have included an export file named `BookIT_Postman_Collection.json` in the root of the project. This contains every API route pre-configured.

1. Open [Postman](https://www.postman.com/downloads/).
2. Click **Import** (top left).
3. Drag and drop the `BookIT_Postman_Collection.json` file into the window.
